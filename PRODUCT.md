...
Focused, dependable, and crafted. The product should feel calm and capable while retaining evidence of thoughtful editorial care. Its voice is direct, helpful, and professional rather than conversational for its own sake.

## Anti-references

The interface must not resemble a generic AI chatbot, a noisy analytics dashboard, or an over-decorated “futuristic AI” tool. Avoid visual spectacle that competes with the work, novelty controls that obscure familiar actions, and AI-themed decoration that does not communicate state or meaning.
...
Use WCAG 2.2 AA as the baseline. Support complete keyboard navigation, visible focus states, sufficient text and control contrast, reduced-motion preferences, and readable, well-spaced typography in both Thai and English. Important status and validation information must never rely on color alone.
